            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        if (curAccount == null)
                            System.out.println("Wrong id account or password!!!");
                        else
                            quit = true;
                        break;
                    case 3:
                ...
                do {
                    ...
                    switch (choice) {
                        case 1:
                            ...
                            if (result == -1)
                                System.out.println(
                                        "Your balance is not enough to withdraw!! Withdraw money including transaction fe");
                            if (result == 1)
                        ...
                        case 2:
                            ...
                            if (result == -1)
                                System.out.println(
                                        "Deposit process failed because deposit money is not greater than 1 after including transaction fees!!!");
                            if (result == 0)
                                System.out.println("Deposit process is failed!!");
                            if (result == 1)
                        ...
                        case 3:
                            ...
                            if (result == -1)
                                System.out.println("Your balance is not enough to execute this transfer");
                            if (result == 1)
                            ...
                            if (result == -2)
                                System.out.println("ID Account doesn't exist!!!");
                            if (result == -4)
                                System.out.println("Your balance must have at lease 1 usd!!!!!");
                            break;
                        case 4:
                            ...
                            if (result == -1)
                                System.out.println("Remove account failed!!!");
                            if (result == -3) {
                                System.out.println("Remove account canceled!!");
                            }
                            if (result == -4)
                                System.out.println("Your balance must have at least 1 usd!!!");
                            break;
                        case 5:
                            ...
                            if (result == -3)
                                System.out.println("New password must be different with old password!!!!");
                            break;
                        case 6:
